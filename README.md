...
## Status
- Indexes TypeScript/TSX, Rust, Kotlin, C++, C#, Python, Go, and Ruby, storing results in a local SQLite database
...
- `src/languages/`: language parsers (TypeScript, Rust, Kotlin, C++, C#, Python, Go, Ruby) built on tree-sitter
